...
// useRouter dan next/navigation dihapus karena tidak digunakan dan menyebabkan error
import { Controller, SubmitHandler, useForm, UseFormRegisterReturn } from 'react-hook-form';
// dynamic dan react-select dihapus/diganti dengan komponen native untuk mengatasi error
// Tambahkan ikon dari lucide-react untuk tampilan yang lebih baik
import { User, Mail, Lock, Phone, ChevronDown } from 'lucide-react';
import { useRouter } from 'next/navigation';

// 1. Perbarui interface untuk mencakup semua field yang diminta:
// Nama Lengkap, Username, Email, Password, dan Nomor WhatsApp.
interface FormValue {
  nama: string;
  username: string;
  email: string;
  password: string;
  nomor_telepon: string; // Nomor WhatsApp
  tipe_akun: string; // Tipe Akun
}
